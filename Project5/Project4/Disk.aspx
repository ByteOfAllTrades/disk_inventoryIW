<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disk.aspx.cs" Inherits="Project4.Disk" MasterPageFile="~/Site.Master" Title="Disk" %>
...
Added Comments for readability
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="CD_id" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
        ...
        <EditItemTemplate>
            <!-- Allows for editing of disk information-->
            <tr style="color:black;" class="btn-danger">
                <td>
        ...
        <EmptyDataTemplate>
            <!-- Returns a label if no data is provided-->
        ...
        <SelectedItemTemplate>
            <!-- Cause rows to be temporarily darkened on hover-->
            <tr style="">
                <td>
                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" CausesValidation="false" CssClass="btn btn-danger focus" ForeColor="Black"/>
                    <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="Edit" CausesValidation="false" CssClass="btn btn-danger focus" ForeColor="Black"/>
    ...
    <!-- Sql datasource and command list-->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventoryIWConnectionString %>" 
        ...
        InsertCommand="execute sp_InsCD @CD_name, @status_id, @genre_id, @type_id" 
